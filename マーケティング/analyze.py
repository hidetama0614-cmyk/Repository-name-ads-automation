...
拡張方法:
    ...
    normalize_<platform>() を追加し、keyword_report.py から渡すだけでよい。
"""
...
def run(keyword_rows: list, sh, config: dict):
    """keyword_report.py から呼び出す。keyword_rows は keyword_report.py が構築したリストをそのまま渡す。"""
