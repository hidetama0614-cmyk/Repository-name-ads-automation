...
def fetch_keyword_hon_cv(client):
    ...
    """
    # key -> {"always": float, "taiken": {action_name: float}}
    raw = {}
...
def main():
    ...
    # キーワード行に本CVを結合
    # row構成: [campaign, ad_group, keyword, match_type, imp, clicks, cost, ctr]
    ...
    # キャンペーン行に本CVを結合
    # row構成: [id, name, status, imp, clicks, cost]
